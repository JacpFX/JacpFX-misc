...
public class CanvasComponent implements FXComponent {
    ...
    private void initEventHandler(final Canvas canvas) {
        canvas.addEventHandler(MouseEvent.MOUSE_PRESSED, (event) ->
            context.send(BaseConfig.getGlobalId(BaseConfig.DRAWING_PERSPECTIVE, BaseConfig.MQTT_COMPONENT),
    ...
    private void addClearButton(final FXComponentLayout layout) {
        ...
        clear.setOnMouseClicked(context.getEventHandler(BaseConfig.getGlobalId(BaseConfig.DRAWING_PERSPECTIVE, BaseConfig.MQTT_COMPONENT),
