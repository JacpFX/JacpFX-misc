...
public class MQTTClient implements CallbackComponent, MqttCallback {
    ...
    public void messageArrived(String s, MqttMessage mqttMessage) throws Exception {
        try {
            context.send(BaseConfig.getGlobalId(BaseConfig.DRAWING_PERSPECTIVE, BaseConfig.CANVAS_COMPONENT), MessageUtil.getMessage(mqttMessage.getPayload(), CanvasPoint.class));
